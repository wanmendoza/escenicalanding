...
function icon_library_submenu_page_callback() {
	...
	$mk_icons_list = array(
          ...
          'mk-icon-music' => "001",
          'mk-icon-search' => "002",
          'mk-icon-envelope' => "003",
          'mk-icon-heart' => "004",
          'mk-icon-star' => "005",
          'mk-icon-star-empty' => "006",
          'mk-icon-user' => "007",
          'mk-icon-film' => "008",
          'mk-icon-th-large' => "009",
          'mk-icon-th' => "00a",
          'mk-icon-th-list' => "00b",
          'mk-icon-ok' => "00c",
          'mk-icon-remove' => "00d",
          'mk-icon-zoom-in' => "00e",
          'mk-icon-zoom-out' => "010",
          'mk-icon-off' => "011",
          'mk-icon-signal' => "012",
          'mk-icon-cog' => "013",
          'mk-icon-trash' => "014",
          ...
          'mk-icon-time' => "017",
          'mk-icon-road' => "018",
          'mk-icon-download-alt' => "019",
          'mk-icon-download' => "01a",
          'mk-icon-upload' => "01b",
          'mk-icon-inbox' => "01c",
          'mk-icon-play-circle' => "01d",
          'mk-icon-repeat' => "01e",
          'mk-icon-refresh' => "021",
          'mk-icon-list-alt' => "022",
          'mk-icon-lock' => "023",
          'mk-icon-flag' => "024",
          'mk-icon-headphones' => "025",
          'mk-icon-volume-off' => "026",
          'mk-icon-volume-down' => "027",
          'mk-icon-volume-up' => "028",
          'mk-icon-qrcode' => "029",
          'mk-icon-barcode' => "02a",
          'mk-icon-tag' => "02b",
          'mk-icon-tags' => "02c",
          'mk-icon-book' => "02d",
          'mk-icon-bookmark' => "02e",
          'mk-icon-print' => "02f",
          'mk-icon-camera' => "f030",
          'mk-icon-font' => "f031",
          'mk-icon-bold' => "f032",
          ...
          'mk-icon-list' => "03a",
          'mk-icon-indent-left' => "f03b",
          'mk-icon-indent-right' => "f03c",
          'mk-icon-facetime-video' => "f03d",
          'mk-icon-picture' => "f03e",
          'mk-icon-pencil' => "f040",
          ...
          'mk-icon-plus-sign' => "f055",
          'mk-icon-minus-sign' => "f056",
          'mk-icon-remove-sign' => "f057",
          'mk-icon-ok-sign' => "f058",
          'mk-icon-question-sign' => "f059",
          'mk-icon-info-sign' => "f05a",
          'mk-icon-screenshot' => "f05b",
          'mk-icon-remove-circle' => "f05c",
          'mk-icon-ok-circle' => "f05d",
          'mk-icon-ban-circle' => "f05e",
          'mk-icon-arrow-left' => "f060",
          'mk-icon-arrow-right' => "f061",
          'mk-icon-arrow-up' => "f062",
          'mk-icon-arrow-down' => "f063",
          'mk-icon-share-alt' => "f064",
          'mk-icon-resize-full' => "f065",
          'mk-icon-resize-small' => "f066",
          'mk-icon-plus' => "f067",
          'mk-icon-minus' => "f068",
          'mk-icon-asterisk' => "f069",
          'mk-icon-exclamation-sign' => "f06a",
          'mk-icon-gift' => "f06b",
          'mk-icon-leaf' => "f06c",
          'mk-icon-fire' => "f06d",
          'mk-icon-eye-open' => "f06e",
          'mk-icon-eye-close' => "f070",
          'mk-icon-warning-sign' => "f071",
          'mk-icon-plane' => "f072",
          ...
          'mk-icon-folder-close' => "f07b",
          'mk-icon-folder-open' => "f07c",
          'mk-icon-resize-vertical' => "f07d",
          'mk-icon-resize-horizontal' => "f07e",
          'mk-icon-bar-chart' => "f080",
          'mk-icon-twitter-sign' => "f081",
          'mk-icon-facebook-sign' => "f082",
          'mk-icon-camera-retro' => "f083",
          'mk-icon-key' => "f084",
          'mk-icon-cogs' => "f085",
          'mk-icon-comments' => "f086",
          'mk-icon-thumbs-up' => "f087",
          'mk-icon-thumbs-down' => "f088",
          'mk-icon-star-half' => "f089",
          'mk-icon-heart-empty' => "f08a",
          'mk-icon-signout' => "f08b",
          'mk-icon-linkedin-sign' => "f08c",
          'mk-icon-pushpin' => "f08d",
          'mk-icon-external-link' => "f08d",
          'mk-icon-signin' => "f090",
          'mk-icon-trophy' => "f091",
          'mk-icon-github-sign' => "f092",
          'mk-icon-upload-alt' => "f093",
          'mk-icon-lemon' => "f094",
          'mk-icon-phone' => "f095",
          'mk-icon-check-empty' => "f096",
          'mk-icon-bookmark-empty' => "f097",
          'mk-icon-phone-sign' => "f098",
          ...
          'mk-icon-hand-right' => "f0a4",
          'mk-icon-hand-left' => "f0a5",
          'mk-icon-hand-up' => "f0a6",
          'mk-icon-hand-down' => "f0a7",
          'mk-icon-circle-arrow-left' => "f0a8",
          'mk-icon-circle-arrow-right' => "f0a9",
          'mk-icon-circle-arrow-up' => "f0aa",
          'mk-icon-circle-arrow-down' => "f0ab",
          'mk-icon-globe' => "f0ac",
          'mk-icon-wrench' => "f0ad",
          'mk-icon-tasks' => "f0ae",
          'mk-icon-filter' => "f0b0",
          'mk-icon-briefcase' => "f0b1",
          'mk-icon-fullscreen' => "f0b2",
          'mk-icon-group' => "f0c0",
          'mk-icon-link' => "f0c1",
          'mk-icon-cloud' => "f0c2",
          'mk-icon-beaker' => "f0c3",
          'mk-icon-cut' => "f0c4",
          'mk-icon-copy' => "f0c5",
          'mk-icon-paper-clip' => "f0c6",
          'mk-icon-save' => "f0c7",
          'mk-icon-sign-blank' => "f0c8",
          ...
          'mk-icon-pinterest-sign' => "f0d3",
          'mk-icon-google-plus-sign' => "f0d4",
          ...
          'mk-icon-envelope-alt' => "f0e0",
          'mk-icon-linkedin' => "f0e1",
          'mk-icon-undo' => "f0e2",
          'mk-icon-legal' => "f0e3",
          'mk-icon-dashboard' => "f0e4",
          'mk-icon-comment-alt' => "f0e5",
          'mk-icon-comments-alt' => "f0e6",
          'mk-icon-bolt' => "f0e7",
          'mk-icon-sitemap' => "f0e8",
          'mk-icon-umbrella' => "f0e9",
          'mk-icon-paste' => "f0ea",
          'mk-icon-lightbulb' => "f0eb",
          ...
          'mk-icon-bell-alt' => "f0f3",
          'mk-icon-coffee' => "f0f4",
          'mk-icon-food' => "f0f5",
          'mk-icon-file-alt' => "f0f6",
          'mk-icon-building' => "f0f7",
          'mk-icon-hospital' => "f0f8",
          'mk-icon-ambulance' => "f0f9",
          'mk-icon-medkit' => "f0fa",
          'mk-icon-fighter-jet' => "f0fb",
          'mk-icon-beer' => "f0fc",
          'mk-icon-h-sign' => "f0fd",
          'mk-icon-plus-sign-alt' => "f0fe",
          'mk-icon-double-angle-left' => "f100",
          'mk-icon-double-angle-right' => "f101",
          'mk-icon-double-angle-up' => "f102",
          'mk-icon-double-angle-down' => "f103",
          ...
          'mk-icon-folder-close-alt' => "f114",
          'mk-icon-folder-open-alt' => "f115",
          'mk-icon-expand-alt' => "f116",
          'mk-icon-collapse-alt' => "f117",
          'mk-icon-smile' => "f118",
          'mk-icon-frown' => "f119",
          'mk-icon-meh' => "f11a",
          'mk-icon-gamepad' => "f11b",
          'mk-icon-keyboard' => "f11c",
          'mk-icon-flag-alt' => "f11d",
          ...
          'mk-icon-microphone-off' => "f131",
          'mk-icon-shield' => "f132",
          'mk-icon-calendar-empty' => "f133",
          'mk-icon-fire-extinguisher' => "f134",
          'mk-icon-rocket' => "f135",
          'mk-icon-maxcdn' => "f136",
          'mk-icon-chevron-sign-left' => "f137",
          'mk-icon-chevron-sign-right' => "f138",
          'mk-icon-chevron-sign-up' => "f139",
          'mk-icon-chevron-sign-down' => "f13a",
          'mk-icon-html5' => "f13b",
          'mk-icon-css3' => "f13c",
          'mk-icon-anchor' => "f13d",
          'mk-icon-unlock-alt' => "f13e",
          'mk-icon-bullseye' => "f140",
          'mk-icon-ellipsis-horizontal' => "f141",
          'mk-icon-ellipsis-vertical' => "f142",
          'mk-icon-rss-sign' => "f143",
          'mk-icon-play-sign' => "f144",
          'mk-icon-ticket' => "f145",
          'mk-icon-minus-sign-alt' => "f146",
          'mk-icon-check-minus' => "f147",
          'mk-icon-level-up' => "f148",
          'mk-icon-level-down' => "f149",
          'mk-icon-check-sign' => "f14a",
          'mk-icon-edit-sign' => "f14b",
          'mk-icon-external-link-sign' => "f14c",
          'mk-icon-share-sign' => "f14d",
          'mk-icon-compass' => "f14e",
          'mk-icon-collapse' => "f150",
          'mk-icon-collapse-top' => "f151",
          'mk-icon-expand' => "f152",
          'mk-icon-eur' => "f153",
          'mk-icon-gbp' => "f154",
          'mk-icon-usd' => "f155",
          ...
          'mk-icon-sort-by-alphabet' => "f15d",
          'mk-icon-sort-by-alphabet-alt' => "f15e",
          'mk-icon-sort-by-attributes' => "f160",
          'mk-icon-sort-by-attributes-alt' => "f161",
          'mk-icon-sort-by-order' => "f162",
          'mk-icon-sort-by-order-alt' => "f163",
          'mk-icon-thumbs-up' => "f164",
          'mk-icon-thumbs-down' => "f165",
          'mk-icon-youtube-sign' => "f166",
          'mk-icon-youtube' => "f167",
          'mk-icon-xing' => "f168",
          'mk-icon-xing-sign' => "f169",
          'mk-icon-youtube-play' => "f16a",
          'mk-icon-dropbox' => "f16b",
          'mk-icon-stackexchange' => "f16c",
          'mk-icon-instagram' => "f16d",
          'mk-icon-flickr' => "f16e",
          'mk-icon-adn' => "f170",
          'mk-icon-bitbucket' => "f171",
          'mk-icon-bitbucket-sign' => "f172",
          'mk-icon-tumblr' => "f173",
          'mk-icon-tumblr-sign' => "f174",
