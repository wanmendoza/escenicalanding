...
while ( $r->have_posts() ) : $r->the_post();
    ...
    if($style == 'simple') {
        ...
        $output .='<div class="animated-column-btn">
                    '.do_shortcode( '[mk_button dimension="savvy" corner_style="pointed" outline_skin="custom" outline_hover_color="'.$btn_color.'" outline_hover_skin="'.$btn_hover_color.'" outline_hover_color='.$btn_hover_txt_color.' size="small" target="'.$target.'" align="center" url="'.$link.'"]'.$btn_txt.'[/mk_button]' ).'
                    </div>';
        }
    }
    $output .= '</div>';
