...
?>
			...
			<?php if ( !empty( $email ) ):?><li><i class="mk-icon-envelope-alt"></i><span><a itemprop="email" href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email);?></a></span></li><?php endif;?>
